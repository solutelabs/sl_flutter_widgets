...
const Color DATETIME_PICKER_BACKGROUND_COLOR = Colors.white;

/// Default value of whether show title widget or not.
const bool DATETIME_PICKER_SHOW_TITLE_DEFAULT = true;

/// Default value of DatePicker's height.
const double DATETIME_PICKER_HEIGHT = 160;

/// Default value of DatePicker's title height.
const double DATETIME_PICKER_TITLE_HEIGHT = 36;

/// Default value of DatePicker's column height.
const double DATETIME_PICKER_ITEM_HEIGHT = 36;
...
class DateTimePickerTheme {
  ...
  /// [title] Custom title widget. If specify a title widget,
  /// the cancel and confirm widgets will not display.
  /// Must set [titleHeight] value for custom title widget.
  /// [showTitle] Whether display title widget or not.
  /// If set false, the default cancel and confirm widgets will not display,
  /// but the custom title widget will display
  ///  if had specified one custom title widget.
  ...
  const DateTimePickerTheme({
    ...
    this.dividerColor,
    this.cancelDefault = const Text('OK'),
    this.alignment,
  });

  ///default cancle
  final Text cancelDefault;

  ///defualt theme of the date time pciker
  ...
  /// Custom title [Widget]. If specify a title widget,
  /// the cancel and confirm widgets will not display.
  final Widget? title;

  /// Whether display title widget or not. If set false,
  ///  the default cancel and confirm widgets will not display,
  /// but the custom title widget will display
  ///  if had specified one custom title widget.
